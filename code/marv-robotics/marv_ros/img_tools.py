...
ENCODINGMAP = {
    ...
    'bayer_rggb8': (8, Format.BAYER_RG, 'uint8', 1),
    'bayer_bggr8': (8, Format.BAYER_BG, 'uint8', 1),
    'bayer_gbrg8': (8, Format.BAYER_GB, 'uint8', 1),
    'bayer_grbg8': (8, Format.BAYER_GR, 'uint8', 1),
    ...
    'bayer_rggb16': (16, Format.BAYER_RG, 'uint16', 1),
    'bayer_bggr16': (16, Format.BAYER_BG, 'uint16', 1),
    'bayer_gbrg16': (16, Format.BAYER_GB, 'uint16', 1),
    'bayer_grbg16': (16, Format.BAYER_GR, 'uint16', 1),
